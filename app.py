...
HARMFUL_INGREDIENTS = [
    ...
    "карагенан", "carrageenan", "e407", "е407","тартразин", "tartrazine", "e102", "е102",
    "алура червено", "allura red", "e129", "е129",
    "сънсет жълто", "sunset yellow", "e110", "е110",
    "еритрозин", "erythrosine", "e127", "е127",
    "брилянтно синьо", "brilliant blue", "e133", "е133",
    "титаниев диоксид", "titanium dioxide", "e171", "е171","bha", "e320", "е320", "бутилиран хидроксианизол", "butylated hydroxyanisole",
    "bht", "e321", "е321", "бутилиран хидрокситолуен", "butylated hydroxytoluene",
    "tbhq", "тбхк", "e319", "е319", "терциерен бутилхидрохинон",
    "пропил галат", "propyl gallate", "e310", "е310"
]
